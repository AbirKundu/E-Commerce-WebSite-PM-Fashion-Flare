...
const products = {
  Saries: [
    ...
    { id: 6, name: "Kanjivaram Sari", price: 4500, image: "/kanjivaram_sari.jpg" },
    { id: 9, name: "Chiffon Sari", price: 2800, image: "/chiffon_sari.jpg" },
  ],
  "3 Pieces": [
    { id: 3, name: "Designer 3 Piece", price: 3200, image: "/designer_3piece.jpg" },
    { id: 4, name: "Casual 3 Piece", price: 2000, image: "/casual_3piece.jpg" },
    { id: 7, name: "Embroidered 3 Piece", price: 3500, image: "/embroidered_3piece.jpg" },
    { id: 8, name: "Festive 3 Piece", price: 4000, image: "/festive_3piece.jpg" },
    { id: 10, name: "Luxury 3 Piece", price: 5000, image: "/luxury_3piece.jpg" },
  ],
  Lehenga: [
    { id: 11, name: "Bridal Lehenga", price: 15000, image: "/bridal_lehenga.jpg" },
    { id: 12, name: "Party Wear Lehenga", price: 9000, image: "/party_lehenga.jpg" },
    { id: 13, name: "Designer Lehenga", price: 12000, image: "/designer_lehenga.jpg" },
  ],
  Kurti: [
    { id: 14, name: "Casual Kurti", price: 2000, image: "/casual_kurti.jpg" },
    { id: 15, name: "Embroidered Kurti", price: 3000, image: "/embroidered_kurti.jpg" },
    { id: 16, name: "Party Wear Kurti", price: 3500, image: "/party_kurti.jpg" },
  ],
};
